...
@router.post("/rate") 
async def set_exchange_rate(request: SetRateRequest) -, Any]: 
...
@router.post("/swap") 
async def swap_zaru_to_usdt(request: SwapRequest) -, Any]: 
    """Swap ZARU to USDT.""" 
    try: 
...
async def withdraw_to_bank(request: WithdrawRequest) -, Any]: 
...
async def get_deposit_address() -, Any]: 
