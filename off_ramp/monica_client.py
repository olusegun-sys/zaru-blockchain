...
class MonicaClient:
    ...
    async def get_deposit_address(self, asset: str = "USDT", network: str = "TRC20") -> Dict[str, Any]:
        """
    ...
    async def get_exchange_rate(self, from_asset: str = "USDT", to_asset: str = "NGN") -> Dict[str, Any]:
        """Get current exchange rate."""
        return await self._request('GET', f'/rates?from={from_asset}&to={to_asset}')
    
    async def withdraw_to_bank(self, amount: float, bank_account: str = None) -> Dict[str, Any]:
        """
